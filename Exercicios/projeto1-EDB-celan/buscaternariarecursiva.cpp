...
int *ternary_search(int *first, int *last, int value){
        ...
        if(value < *middle1) return ternary_search(first, middle1, value);
        else if(value > *middle2) return ternary_search(middle2+1,last,value);
        else return ternary_search(middle1+1,middle2,value);
        return last;
}
int main(){
